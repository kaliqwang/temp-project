...
urlpatterns = [
    ...
    url(r'^users/(?P<pk>\d+)$', views_api.UserViewSet.as_view({'get': 'retrieve', 'put':'update', 'delete':'destroy'}), name='user'),

    url(r'^user_profiles/$', views_api.UserProfileViewSet.as_view({'get':'list', 'post':'create'}), name='user_profiles'),
    url(r'^user_profiles/(?P<pk>\d+)$', views_api.UserProfileViewSet.as_view({'get': 'retrieve', 'put':'update', 'delete':'destroy'}), name='user_profile'),
