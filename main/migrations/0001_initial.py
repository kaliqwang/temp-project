# -*- coding: utf-8 -*-
# Generated by Django 1.9.8 on 2016-08-01 21:51
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image_file', imagekit.models.fields.ProcessedImageField(blank=True, null=True, upload_to='main/images/')),
                ('announcement', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='image_files', to='main.Announcement')),
            ],
        ),
        migrations.CreateModel(
            name='ImageLink',
            fields=[
                ...
                ('image_file', imagekit.models.fields.ProcessedImageField(blank=True, null=True, upload_to='main/images/')),
                ('announcement', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='image_links', to='main.Announcement')),
            ],
        ),
        migrations.CreateModel(
            name='Poll',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categories_hidden_announcements', models.ManyToManyField(blank=True, to='main.Category')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('announcement', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='youtube_videos', to='main.Announcement')),
            ],
        ),
        migrations.AddField(
