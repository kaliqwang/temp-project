$(document).ready(function() {
    ...
    // Polls (w/ votes)
    $('#p_v_1').on('click', function(e) {generate('polls_voted', 1, $(this))});
    $('#p_v_10').on('click', function(e) {generate('polls_voted', 10, $(this))});
    $('#p_v_100').on('click', function(e) {generate('polls_voted', 100, $(this))});
    $('#p_v_1000').on('click', function(e) {generate('polls_voted', 1000, $(this))});
    // Student Profiles
    $('#s_1').on('click', function(e) {generate('student_profiles', 1, $(this))});
    $('#s_10').on('click', function(e) {generate('student_profiles', 10, $(this))});
    $('#s_100').on('click', function(e) {generate('student_profiles', 100, $(this))});
    $('#s_1000').on('click', function(e) {generate('student_profiles', 1000, $(this))});

    function generate(model, count, $button) {
        target = '/generator/' + model + '/' + count + '/';
